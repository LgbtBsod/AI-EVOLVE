...
def test_canonical_kind_and_from_json():
    ...
    assert canonical_kind("deal") == "deal" and canonical_kind("dash") == "dash"        # canon and inexact: unchanged
...
def test_validator_accepts_alias_and_rejects_unknown():
    ...
    assert validate_op({"kind": "dash", "target": "self"}, "op") == ["op: unknown kind 'dash'"]
