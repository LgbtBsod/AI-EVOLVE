# Dev Probe Summary — 2026-09-22 17:51:47
...
[   5.0s] ANOMALY: frame_002.jpg looks blank/solid-color (pixel stddev=0.0) - rendering may be broken even though game state looks fine
[   5.0s] SCREENSHOT frame_002.jpg — run end
...
## Issues detected
- 2 WARNING/ERROR log line(s) captured (see below).
...
## Warnings / errors
17:51:42 ERROR src.scenes.scene_manager: Ошибка запуска SceneManager: 'SceneManager' object has no attribute 'system_state'
17:51:42 WARNING src.core.game_core: Не удалось запустить SceneManager
