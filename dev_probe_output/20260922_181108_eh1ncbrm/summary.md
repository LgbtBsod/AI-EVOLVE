# Dev Probe Summary — 2026-09-22 18:11:29
...
## Issues detected
- 7 WARNING/ERROR log line(s) captured (see below).
...
## Warnings / errors
18:11:09 WARNING src.core.architecture: Недопустимый переход состояния: UNINITIALIZED -> READY
18:11:09 WARNING src.core.architecture: Недопустимый переход состояния: UNINITIALIZED -> READY
18:11:09 WARNING src.core.architecture: Недопустимый переход состояния: UNINITIALIZED -> UNINITIALIZED
18:11:09 WARNING src.core.architecture: Недопустимый переход состояния: UNINITIALIZED -> READY
18:11:09 ERROR src.scenes.scene_manager: SceneManager не готов к запуску
18:11:09 WARNING src.core.game_core: Не удалось запустить SceneManager
18:11:09 WARNING src.scenes.scene_manager: Сцена с ID game_world не найдена
...
Raw per-tick state: state.jsonl (20 samples)
