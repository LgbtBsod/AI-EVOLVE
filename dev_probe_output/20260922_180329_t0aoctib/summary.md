# Dev Probe Summary — 2026-09-22 18:03:54

Status: OK

Config: duration=25.0s dev_map=True seed=None actions=['1.0s:1', '2.0s:2', '3.0s:3']
...
## Warnings / errors
18:03:29 WARNING src.core.architecture: Недопустимый переход состояния: UNINITIALIZED -> READY
18:03:29 WARNING src.core.architecture: Недопустимый переход состояния: UNINITIALIZED -> READY
18:03:29 WARNING src.core.architecture: Недопустимый переход состояния: UNINITIALIZED -> READY
18:03:29 ERROR src.scenes.scene_manager: SceneManager не готов к запуску
18:03:29 WARNING src.core.game_core: Не удалось запустить SceneManager
18:03:29 WARNING src.scenes.scene_manager: Сцена с ID game_world не найдена
