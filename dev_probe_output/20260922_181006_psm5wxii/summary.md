# Dev Probe Summary — 2026-09-22 18:10:22

Status: OK

Config: duration=15.0s dev_map=True seed=42 actions=[]
...
[  15.1s] ANOMALY: frame_002.jpg looks blank/solid-color (pixel stddev=0.0) - rendering may be broken even though game state looks fine
...
## Warnings / errors
18:10:07 WARNING src.core.architecture: Недопустимый переход состояния: UNINITIALIZED -> READY
18:10:07 WARNING src.core.architecture: Недопустимый переход состояния: UNINITIALIZED -> READY
18:10:07 WARNING src.core.architecture: Недопустимый переход состояния: UNINITIALIZED -> READY
18:10:07 ERROR src.scenes.scene_manager: SceneManager не готов к запуску
18:10:07 WARNING src.core.game_core: Не удалось запустить SceneManager
18:10:07 WARNING src.scenes.scene_manager: Сцена с ID game_world не найдена
